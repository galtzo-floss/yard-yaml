...
# yard-yaml Rakefile v7.1.10 - 2026-08-29
...
# rake install                                # Build and install yard-yaml-1.0.0.gem in...
# rake install:local                          # Build and install yard-yaml-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template yard-yaml against itse...
