...
gem_version =
  if RUBY_VERSION >= "3.1" # rubocop:disable Gemspec/RubyVersionGlobalsUsage
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/yard/yaml/version.rb", mod) }::Yard::Yaml::Version::VERSION
  else
    ...
    require "yard/yaml/version"
    Yard::Yaml::Version::VERSION
  end
...
Gem::Specification.new do |spec|
  ...
  # The 'git' gem is optional; yard-yaml falls back to shelling out to `git` if it is not present.
